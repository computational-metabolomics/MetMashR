...
.annotation_histogram2d<-setClass(
    ...
    prototype = list(
        ...
        description=paste0(
            ...
            'annotation_source.'),
        type="histogram",
        .params=c('factor_name','bins','bin_edge','bin_fill','vline',
                  'vline_colour'),
        ...
        vline = entity(
            ...
            description = paste0(
                ...
                'upper and lower limits. Use NULL if not required. A 2 element ',
...
setMethod(f="chart_plot",
          ...
          definition=function(obj,dobj) {
              ...
              # 2d histogram
              g1 = ggplot(data = dobj$data,
                          aes(x = as.numeric(.data[[obj$factor_name[1]]]),
