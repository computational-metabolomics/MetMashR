#' @eval get_description('concatenate_columns')
#' @export
...
.concatenate_columns<-setClass(
    ...
    prototype=list(
        ...
        description = paste0(
            ...
            'values in two columns row-wise.'),
        type = 'processing',
        predicted = 'updated',
        .params=c('column_names','separator','output_column','clean',
                  'prefix','suffix'),
        ...
        column_names = entity(
            name = 'Column names',
            description =paste0(
                'The column name(s) in the annotation_source concatenate.'),
            type=c('character'),
            value='V1',
            max_length=Inf
        ),
        ...
        prefix = entity(
            name = 'Prefix',
            description = paste0(
                'A string placed at the start of the concatenated strings'),
        ...
        suffix = entity(
            name = 'Suffix',
            description = paste0(
                'A string placed at the end of the concatenated strings'),
            type = c('character','NULL'),
            max_length = 1,
            value = NULL
        ),
        ...
        output_column = entity(
            name = 'Column name',
            description = paste0(
                'The name of a column to store the concatenated values in.'),
            value='concatenated',
            type='character',
            max_length = 1
        ),
        ...
        updated = entity(
            ...
            description = paste0(
                'The annotation_source after concatenating the columns.'),
...
setMethod(f="model_apply",
          signature=c("concatenate_columns","annotation_source"),
          definition=function(M,D) {
              ...
              # cat columns
              out = as.character(do.call(interaction,L))
