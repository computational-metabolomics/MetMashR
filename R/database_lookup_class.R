...
.database_lookup<-setClass(
    ...
    prototype=list(
        ...
        predicted = 'updated',
        libraries = 'dplyr',
        .params=c('query_column','database_column','database','include',
                  'suffix','not_found'),
        .outputs=c('updated'),
        ...
        database_column = entity(
            ...
            description = paste0('The database column to search for matches ',
        ...
        include = entity(
            ...
            description = paste0('The name of the database columns to be ',
...
setMethod(f="model_apply",
          ...
          definition=function(M,D) {
              ...
              # match class to db
              X[[M$query_column]] = as(X[[M$query_column]],
