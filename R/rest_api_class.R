...
.rest_api = setClass(
    ...
    prototype=list(
        ...
        type = 'REST API',
        predicted = 'updated',
        .params = c('base_url','url_template','query_column',
        ...
        suffix = entity(
            ...
            description = paste0('A suffix appended to all column names in ',
                                 'the returned result.'),
            value = '_rest_api',
            type='character',
            max_length = 1
        ...
        status_codes = entity(
            ...
            type='list',
            value = list(
                '200' = function(response,...){return(content(response))},
        ...
        updated = entity(
            ...
            description = paste0('The annotation_source after adding data ',
                                 'returned by the API.'),
...
setMethod(f="model_apply",
          ...
          definition=function(M,D) {
              ...
              X = dplyr::left_join(D$data,collected, by=by,
