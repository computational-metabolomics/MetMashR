...
.openbabel_structure<-setClass(
    ...
    prototype = list(
        ...
        description=paste0(
            ...
            'OpenBabel.'),
        type="image",
        .params=c('smiles_column','image_size','hydrogens','carbons','double_bonds',
...
setMethod(f="chart_plot",
          ...
          definition=function(obj,dobj) {
              ...
              # create image
              ChemmineOB::convertToImage('smiles','svg',smiles,tf,
                                         genOpts,outOpts)
              ...
              # plot
              h = ggplot()+ggtitle(title,subtitle)+theme_void()
              g = cowplot::ggdraw() + 
