...
.excel_database <- setClass(
    ...
    prototype = list(
        ...
        rowNames = entity(
            name = 'Row names',
            description = 'If TRUE, first column of data will be used as row names.',
            type = 'logical',
            value = FALSE,
            max_length = 1
        ),
        ...
        colNames = entity(
            name = 'Col names',
            description = 'If TRUE, first row of data will be used as column names.',
            type = 'logical',
            value = FALSE,
            max_length = 1
        ),
        ...
        startRow = entity(
            name = 'Start row',
            description = 'First row to begin looking for data. Empty rows at the top of a file are always skipped, regardless of the value of startRow.',
