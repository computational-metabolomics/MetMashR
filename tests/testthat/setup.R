...
httptest::set_requester(
    function(request){
        ...
        httptest::gsub_request('https\\://www.metabolomicsworkbench.org/rest/compound/',"mwb/") %>%
        httptest::gsub_request('http\\://classyfire.wishartlab.com/entities',"cf/") %>%
        httptest::gsub_request('http\\://rest.kegg.jp/entities/conv',"kg/")
    }
)
...
httptest::set_redactor(
    function(response){
        httptest::gsub_response(response,'https\\://www.lipidmaps.org/rest',"lm/") %>%
            ...
            httptest::gsub_response('https\\://www.metabolomicsworkbench.org/rest/compound/',"mwb/") %>%
            httptest::gsub_response('http\\://classyfire.wishartlab.com/entities',"cf/") %>%
            httptest::gsub_response('http\\://rest.kegg.jp/entities/conv',"kg/")
    }
)
