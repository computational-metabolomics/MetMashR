structure(list(url = "pc/name/no_hit/cids/JSON", status_code = 404L, 
    headers = structure(list(date = "Thu, 08 Feb 2024 09:42:54 GMT", 
    ...
    "list")), all_headers = list(list(status = 404L, version = "HTTP/1.1", 
        ...
        flag = TRUE, path = "/", secure = FALSE, expiration = structure(1739007774, class = c("POSIXct", 
    ...
    date = structure(1707385374, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.047154, 
    connect = 0.143154, pretransfer = 0.340375, starttransfer = 0.482617, 
    total = 0.485312)), class = "response")
